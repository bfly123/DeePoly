...
Previous versions:
- **v0.1 (Beta)**: Initial release with function approximation and PDE solving test cases
- **v0.2**: High-accuracy solving for arbitrary-dimensional linear PDEs, auto code generation, English documentation

**Current version: v0.3**:
- Enhanced nonlinear equation solving with LM damping, Wolfe line search, and trust region methods
- Unified codebase architecture with BasePDEConfig and factory patterns
- Time-dependent PDE solving with onestep_predictor second-order time integration
- Comprehensive boundary condition unification with GPU acceleration
- Automatic code generation and maintenance with auto_spotter.py
- Allen-Cahn equation solving achieving 10-second computation time
- Complete documentation overhaul with comprehensive test case validation
